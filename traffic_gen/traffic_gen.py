...
if __name__ == "__main__":
	port = 80
	parser = OptionParser()
	defaultCdfPath = os.getcwd() + "/traffic_gen/uniform_distribution.txt"
	defaultOutputPath = os.getcwd() + "/config/tmp_traffic.txt"
	parser.add_option("-c", "--cdf", dest = "cdf_file", help = "the file of the traffic size cdf", default = defaultCdfPath)
	parser.add_option("-n", "--nhost", dest = "nhost", help = "number of hosts", default="128")
	...
	parser.add_option("-o", "--output", dest = "output", help = "the output file", default = defaultOutputPath)
