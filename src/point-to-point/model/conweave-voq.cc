...
void ConWeaveVOQ::Set(uint64_t flowkey, uint32_t dip, Time timeToFlush, Time extraVOQFlushTime, uint32_t outport) {
    m_flowkey = flowkey;
    m_dip = dip;
