...
class ConWeaveVOQ {
   ...
   public:
    ...
    // functions
    void Set(uint64_t flowkey, uint32_t dip, Time timeToFlush, Time extraVOQFlushTime, uint32_t outport);  // setup
    ...
    uint32_t getOutPort() { return m_outport; };
